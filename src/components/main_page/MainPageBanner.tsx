...
const MainPageBanner = () => {
    return <section className={styles.TccSiteFirstPage}>
            ...
            <div className={styles.container2}>
                <div className={styles.container3}>
                    <div className={styles.TccSiteFirstPage_text}>
                        ...
                        <p>
                            <span className={styles.span6}>♥️我们特意重新构建了网页，只为您更美好的体验.♥️</span>
                            <br/>
                            <span className={styles.span7}>🔥并加入了许多功能，希望您对Tcc的热爱持之以恒.🔥</span>
                        </p>
                        <div className={styles.button}>
                            <a href="https://www.bilibili.com/video/BV1ma4y1y7CA/?spm_id_from=333.788" target="_blank" className={styles.btn}>🔥点击即可加入Tcc!!!🔥</a>
                        </div>
                    </div>
                </div>
